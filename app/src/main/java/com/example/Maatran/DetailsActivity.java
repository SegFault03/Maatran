...
public class DetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save.setOnClickListener(view -> {
            ...
            int mobile = Integer.parseInt(((EditText) findViewById(R.id.mobile_number)).getText().toString());
            int emergency_mobile = Integer.parseInt(((EditText) findViewById(R.id.emergency_no)).getText().toString());
            ...
            if(Integer.toString(emergency_mobile).length()!=10)
            {
            ...
            if(flag)
            {
                ...
                FirebaseHandler fdb = new FirebaseHandler(name, gender, address, Integer.toString(mobile), Integer.toString(emergency_mobile), age, isPatient);
                fdb.addDetails(user);
